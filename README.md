> ✅ TypeScript 심화 로드맵 21개 모두 완료. routine을 disable하거나 새 주제로 갱신하세요: https://claude.ai/code/routines/trig_01XHrYcCV9cyTSgTU7ohWSRc
...
- [var / let / const 와 TDZ](js/var-let-const-tdz.md)
- [호이스팅 (Hoisting)](js/hoisting.md)
